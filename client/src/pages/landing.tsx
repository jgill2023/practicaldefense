    ...
    <Layout>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8">
          <h1 className="uppercase mb-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl" style={{ fontFamily: "'Vast Shadow', cursive", fontWeight: 400, letterSpacing: '3px', lineHeight: '1.1em' }}>
            Tactical Advantage
          </h1>
