    ...
    <Layout>
      ...
      <section id="courses" className="bg-muted py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div id="deductive-pistolcraft" className="bg-card rounded-lg overflow-hidden shadow-lg mb-8 scroll-mt-20 md:scroll-mt-28" data-testid="feature-deductive-pistolcraft">
