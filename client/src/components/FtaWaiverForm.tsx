...
export const FTA_WAIVER_VERSION = "2021-v1";

export const FTA_WAIVER_TEXT = `FTA RELEASE AND WAIVER
...
export function FtaWaiverSuccessCard({ submittedData }: { submittedData: any }) {
  return (
