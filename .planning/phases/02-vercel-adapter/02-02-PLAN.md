...
This documents the blocker/concern from STATE.md about pooled vs. direct connections.
  ...
  <done>vercel.json is created with correct routing, build command, and output directory. .env.example documents both pooled and direct database URLs.</done>
</task>
...
<task type="checkpoint:human-action" gate="blocking">
  ...
  <what-needs-doing>
    ...
    **Step 3: Set Environment Variables**
    ...
    | STRIPE_WEBHOOK_SECRET | Stripe Dashboard -> Developers -> Webhooks -> Signing secret | Production |
